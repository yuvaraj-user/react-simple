...
//       if (isClosed == true) {
//         overlay.hide();
//         trigger.removeclassName('is-open');
//         trigger.addclassName('is-closed');
//         isClosed = false;
//       } else {
//         overlay.show();
//         trigger.removeclassName('is-closed');
//         trigger.addclassName('is-open');
//         isClosed = true;
//       }
//   }
...
export default function Dashboard() {
  ...
  return (
    ...
    <div id="wrapper" className={isClosed ? "toggled" : ""}>
        <div className={isClosed ? "overlay d-none" : "overlay"}></div>
        <nav
        ...
        >
          <ul className="nav sidebar-nav">
            ...
            <li className="dropdown">
              <a href="#works" className="dropdown-toggle" data-bs-toggle="dropdown">
